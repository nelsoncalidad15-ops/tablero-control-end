...
export const QUALITY_OBJECTIVES_SCALES_SHEET_KEY = "quality_objectives_scales";
...
export const WARRANTY_Q1_SHEET_KEY = "warranty_q1";
export const WARRANTY_Q2_SHEET_KEY = "warranty_q2";
export const WARRANTY_Q3_SHEET_KEY = "warranty_q3";
export const WARRANTY_Q4_SHEET_KEY = "warranty_q4";
...
export const DEFAULT_CONFIG = {
  sheetUrls: {
    ...
    quality_objectives_scales: QUALITY_OBJECTIVES_SCALES_SHEET_KEY,
