        ...
        },
        {
            ...
            render: (_: any, row: any) => (
                <div className="min-w-[400px] max-w-2xl">
                    <div className="text-slate-950 font-bold text-[11px] leading-relaxed mb-3">"{row.reclamo || 'Sin descripci�n'}"</div>
                ...
                <div className="min-w-[350px] max-w-xl space-y-3">
                    {row.analisis_causa && (
                        <div className="flex gap-3">
                            ...
                            <div>
                                <div className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">An�lisis de Causa</div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                        {row.accion_contencion && (
                            <div className="bg-orange-50/50 p-2 rounded-xl border border-orange-100/50">
                                <div className="text-[8px] font-black text-orange-600 uppercase tracking-widest mb-1">Contenci�n</div>
    ...
    return (
        <div className="space-y-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                />
                <LuxuryKPICard title="D�as Prom. Demora" value={Number(avgDelay)} color="bg-blue-600" icon={Icons.Activity} />
            </div>
            ...
            <ChartWrapper
                title="Gesti�n por Sector Responsable"
