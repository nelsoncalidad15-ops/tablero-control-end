  ...
  return (
    ...
    >
      <div className="space-y-5 pb-16 bg-[#f7f9fc]">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select 
                ...
                className="text-xs font-bold text-slate-800 bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200 outline-none cursor-pointer hover:border-blue-300 transition-colors"
              >
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                <Icons.Users className="w-3.5 h-3.5 text-emerald-600" /> Asesor
              </span>
              <select 
                value={selectedAsesor || ''} 
                onChange={(e) => setSelectedAsesor(e.target.value || null)}
                className="text-xs font-bold text-slate-800 bg-slate-50 px-3 py-1.5 rounded-xl border border-slate-200 outline-none cursor-pointer hover:border-blue-300 transition-colors max-w-[200px]"
              >
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                <Icons.Star className="w-3.5 h-3.5 text-amber-500" /> Nota LVS
              </span>
              <select 
            ...
            <div className="flex flex-col gap-1.5">
              <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                <Icons.MapPin className="w-3.5 h-3.5 text-rose-500" /> Sucursal
              </span>
          ...
          <div className="flex items-center gap-3">
            ...
            {(selectedMonth || selectedAsesor || selectedLvsScore || selectedCategory || selectedSucursal) && (
              <button 
                ...
                className="px-3.5 py-1.5 rounded-xl bg-slate-100 text-xs font-bold text-slate-600 hover:bg-slate-200 transition-all flex items-center gap-1.5"
              >
        ...
        {/* KPI Cards Grid - Compact Modern Style */}
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-5 gap-3.5 md:gap-4">
          {[
            ...
            <div 
              key={i}
              className="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden flex flex-col justify-between"
            >
              <div className="flex justify-between items-start mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-xs font-bold text-slate-700 uppercase tracking-tight leading-tight">{kpi.title}</h3>
                </div>
              ...
              <div className="flex items-baseline gap-1.5 mb-3">
                <span className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-none">{kpi.val.toFixed(2)}</span>
                <span className="text-xs font-semibold text-blue-600">/ 5.0</span>
              </div>
        ...
        {/* Categorización & Advisor Ranking Grid */}
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
              ...
              {categorizacionData.slice(0, 6).map((item, idx) => {
                ...
                return (
                  <div 
                    ...
                    className={`flex items-center gap-3.5 group cursor-pointer px-3.5 py-2 rounded-xl transition-all ${
                      isSelected ? 'bg-blue-50 border border-blue-200 shadow-xs' : 'hover:bg-slate-50 border border-transparent'
                    }`}
                  >
                    <div className="w-44 sm:w-56 text-right shrink-0">
                      <span className={`text-xs font-semibold uppercase tracking-tight block truncate transition-colors ${
                    ...
                    <div className="w-16 text-right shrink-0">
                      ...
                      <span className="text-[10px] font-medium text-slate-400 uppercase ml-1">casos</span>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="bg-slate-900 rounded-2xl p-5 md:p-6 text-white shadow-sm flex flex-col justify-between relative overflow-hidden">
            <div>
